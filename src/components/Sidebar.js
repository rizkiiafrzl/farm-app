...
<<<<<<< HEAD
        <div className="relative">
          <button
            ...
            className="w-full flex items-center space-x-3 mb-4 focus:outline-none"
          >
...
<<<<<<< HEAD
            ...
            <div className="text-left">
              <p className="font-medium text-primary">{user?.name || 'Loading...'}</p>
        ...
        <button
          ...
          className="w-full text-left p-3 rounded-md text-primary hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
        >
=======
              </div>
              <div>
